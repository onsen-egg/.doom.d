(custom-set-variables
 ...
 '(exec-path
   '("/Users/jolin/Projects/libtool-bin/bin" "/Users/jolin/Projects/cmake-bin/bin" "/usr/local/bin" "/usr/bin" "/bin" "/usr/sbin" "/sbin" "/usr/local/share/dotnet" "/Users/jolin/.nvm/versions/node/v8.0.0/bin" "~/.emacs.d/bin" "/Applications/Emacs.app/Contents/MacOS" "/Applications/Emacs.app/Contents/MacOS/bin-arm64-11" "/Applications/Emacs.app/Contents/MacOS/libexec-arm64-11" "/Applications/Emacs.app/Contents/MacOS/libexec")))
(custom-set-faces
